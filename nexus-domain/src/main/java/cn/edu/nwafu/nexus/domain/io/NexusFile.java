package cn.edu.nwafu.nexus.domain.io;
...
public class NexusFile {
    ...
    public NexusFile(String pathname, boolean isDirectory) {
        this.path = formatPath(pathname);
        this.isDirectory = isDirectory;
    }

    public NexusFile(String parent, String child, boolean isDirectory) {
        if (parent != null) {
    ...
    public NexusFile getParentFile() {
        String parentPath = this.getParent();
        return new NexusFile(parentPath, true);
    }
