...
import cn.edu.nwafu.nexus.domain.io.NexusFile;
...
public class UserFile extends BaseEntity<UserFile> {
    ...
    public UserFile(NexusFile nexusFile, String userId, String fileId) {
        this.id = IdUtil.getSnowflakeNextIdStr();
        this.userId = userId;
        this.fileId = fileId;
        this.filePath = nexusFile.getParent();
        this.fileName = nexusFile.getNameNotExtend();
        this.extension = nexusFile.getExtension();
        this.createUserId = userId;
        this.isDir = nexusFile.isDirectory() ? 1 : 0;
    }
