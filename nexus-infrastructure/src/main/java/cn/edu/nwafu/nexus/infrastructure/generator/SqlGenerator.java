...
public class SqlGenerator {
    ...
    public static void main(String[] args) {
        String packageName = "cn.edu.nwafu.nexus.infrastructure.entity";
    ...
    private static void processFields(Class<?> clz, StringBuilder sql, boolean isSuper) {
        ...
        for (Field field : fields) {
            ...
            // 如果字段是主键且类型为 Long 或 Integer，设置为自增
            TableId tableIdAnnotation = field.getAnnotation(TableId.class);
            if (tableIdAnnotation != null && (field.getType() == Long.class || field.getType() == Integer.class)) {
