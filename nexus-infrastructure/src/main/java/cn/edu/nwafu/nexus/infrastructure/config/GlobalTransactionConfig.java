...
public class GlobalTransactionConfig {
    /**
     * 配置全局事务的切点为 service 层的所有方法 AOP切面表达式，设置在 applicationService 层
     */
    private static final String POINTCUT_EXPRESSION = "execution(public * cn.edu.nwafu.domain..*.*ApplicationService.*(..))";
